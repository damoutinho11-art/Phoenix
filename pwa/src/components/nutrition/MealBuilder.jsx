...
export default function MealBuilder({ onBack, onSuccess }) {
  ...
  if (loading) return <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000', color: MUTED, fontFamily: 'var(--mono)', fontSize: 12 }}>Building meal options…</div>
