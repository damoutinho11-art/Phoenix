...
function Pill({ children, tone = 'neutral' }) {
  ...
  return (
    <span style={{
      ...
      border: `1px solid ${tone === 'pass' ? 'rgba(157,255,111,.3)' : tone === 'fail' ? 'rgba(255,92,122,.32)' : 'rgba(157,255,111,.18)'}`,
      background: tone === 'pass' ? 'rgba(157,255,111,.055)' : tone === 'fail' ? 'rgba(255,92,122,.06)' : 'rgba(157,255,111,.04)',
      padding: '3px 8px'
    }}>{children}</span>
  )
}
      ...
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 92 }}>
        ...
        <div style={{ padding: '16px 18px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
            ...
            <button onClick={load} style={{ padding: '7px 10px', border: `1px solid rgba(157,255,111,.18)`, background: 'rgba(157,255,111,.035)', color: CYAN, fontFamily: 'var(--phx-font-mono)', fontSize: 7, letterSpacing: '.14em' }}>RERUN</button>
          </div>
