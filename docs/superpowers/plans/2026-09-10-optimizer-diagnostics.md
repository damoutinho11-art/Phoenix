# Optimizer diagnostic implementation

- [x] Add and run failing tests for cash/selection/fee attribution.
- [x] Implement offline attribution; reconcile both archived cost cases.
- [x] Add and run failing tests for scenario projection and missing-data handling.
